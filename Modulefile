...
To add this module, add this module and the puppet-apt module (from https://github.com/Tribily/puppet-apt) to your puppet repository and add "include tribily" to all your nodes. That should do the trick!
